...
public class FlockingCellMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors Test : flocking = cohesion cell + alignment cell + separation cell + wander");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new FlockingCellTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
