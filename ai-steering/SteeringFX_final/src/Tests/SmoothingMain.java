...
public class SmoothingMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors Test: smoothing");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new SmoothingTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
