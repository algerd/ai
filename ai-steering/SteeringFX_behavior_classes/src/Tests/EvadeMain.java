...
public class EvadeMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors : Evade");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new EvadeTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
