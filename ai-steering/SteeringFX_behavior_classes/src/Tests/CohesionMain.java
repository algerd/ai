...
public class CohesionMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors Test : cohesion + alignment + separation + wander");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new CohesionTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
