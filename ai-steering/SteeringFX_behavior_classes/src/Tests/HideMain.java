...
public class HideMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Hide");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new HideTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
