...
public class FlockingMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors Test : flocking = cohesion + alignment + separation + wander");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new FlockingTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
