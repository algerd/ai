...
public class FollowPathMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Follow Path");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new FollowPathTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
