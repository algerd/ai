...
public class SeekFleeArriveMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Seek, Flee, Arrive");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new SeekFleeArriveTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
