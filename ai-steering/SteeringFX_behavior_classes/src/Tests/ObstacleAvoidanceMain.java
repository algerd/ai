...
public class ObstacleAvoidanceMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Obstacle avoidance");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new ObstacleAvoidanceTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
