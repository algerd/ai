...
public class InterposeMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Interpose");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new InterposeTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
