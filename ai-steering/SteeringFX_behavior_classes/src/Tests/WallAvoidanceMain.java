...
public class WallAvoidanceMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Wall avoidance");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new WallAvoidanceTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
