...
public class PursuitMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Pursuit");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new PursuitTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
