...
public class OffsetPursuitMain extends Application {
    ...
    public void start(Stage stage) {
		...
		stage.setTitle("Steering Behaviors: Offset pursuit");
		stage.show();
        ...
        ///// Test:  
        GameWorld gameWorld = new OffsetPursuitTest(WINDOW_WIDTH, WINDOW_HEIGHT).getGameWorld();
        /////
