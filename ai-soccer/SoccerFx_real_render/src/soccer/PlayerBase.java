...
abstract public class PlayerBase extends MovingEntity {
    ...
    public PlayerBase(
            ...
            PlayerRoleType role) 
    {
        super(Params.PLAYER_BOUNDING_RADIUS, maxSpeed, mass, maxTurnRate, maxAcceleration);
        ...
        this.position = home_team.getPitch().getRegionFromIndex(home_region).center();
    ...
    public void trackBall() {
        rotateHeading(getBall().getPosition());
    }
    ...
    public void setDefaultHomeRegion(int region) {
        homeRegion = defaultRegion = region;
    }
