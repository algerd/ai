...
public class RenderJS {
    ...
    public int tact;
    private BallRenderJS ball;
    private TeamRenderJS redTeam;
    private TeamRenderJS blueTeam;
    ...
    public RenderJS(Canvas canvas, SoccerPitch soccerPitch) {       
        canvas.setWidth(LENGTH_FIELD);
        canvas.setHeight(WIDTH_FIELD);
        gc = canvas.getGraphicsContext2D();  
        ball = new BallRenderJS(gc, soccerPitch.getBall());
        redTeam = new TeamRenderJS(gc, soccerPitch.getRedTeam(), Color.RED);
        blueTeam = new TeamRenderJS(gc, soccerPitch.getBlueTeam(), Color.BLUE);
    }
