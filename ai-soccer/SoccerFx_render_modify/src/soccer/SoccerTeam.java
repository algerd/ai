...
public class SoccerTeam {
    ...
    private void createPlayers() {
        if (getColor() == blue) {
            ...
            playerList.add(new GoalKeeper(
                ...
                new Vector(0.0, 0.0),
                Params.PLAYER_MASS,
                Params.PLAYER_MAX_FORCE,
                Params.PLAYER_MAX_SPEED_WITHOUT_BALL,
                Params.PLAYER_MAX_TURN_RATE)
            );
            //create the players
    ...
    public void render(GraphicsContext gc) {        
        ...
        if (ParamsRender.RENDER_SHOW_CONTROLLING_TEAM) {
            ...
            if (controllingPlayer != null) {
                gc.strokeText("Controlling Player: " + Integer.toString(controllingPlayer.getId()), FieldRender.LENGTH_FIELD - 150, 11);
            }
        }
        //render the sweet spots
        if (ParamsRender.RENDER_SUPPORT_SPOTS && isControllingPlayer()) {
