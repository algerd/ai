...
public class ReturnToHomeRegion extends State<FieldPlayer> {
    ...
    public void execute(FieldPlayer player) {
        if (player.getPitch().isGameOn()) {
            ...
            //there is not an assigned receiver && the goalkeeper does not gave the ball, go chase it
        ...
        if (player.getPitch().isGameOn() && player.getHomeRegion().inside(player.getPosition(), Region.halfsize)) {
