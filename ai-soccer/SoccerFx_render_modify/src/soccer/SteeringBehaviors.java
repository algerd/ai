...
public class SteeringBehaviors {
    ...
    public SteeringBehaviors(PlayerBase agent, SoccerPitch world, SoccerBall ball) {
        this.player = agent;
        this.multSeparation = Params.SEPARATION_COEFF;
        this.viewDistSq = Params.DIST_TO_PLAYERS_FOR_SEPARATION_BEHAVIOR_SQ;
        this.ball = ball;
    ...
    /**
     *  tags any players within a viewDistSq.
     */
    ...
    /**
     * !!!TODO Привести lookAheadTime к числу тактов(?)
    ...
    private Vector pursuit() {
        ...
        if (speed != 0.0) {
            lookAheadTime = toBall.length() / speed;
        }
