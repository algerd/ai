...
public class Transformation {
    ...
    // трансформирует вершины фигуры согласно заданному положению, направлению и масштабу.
    public static void transform(List<Vector> pointList, Vector pos, Vector heading, Vector scale) {
        ...
        matTransform.transformVector2Ds(pointList);
    }
    public static void transform(List<Vector> pointList, Vector pos, Vector heading) {
        Matrix matTransform = new Matrix();
        matTransform.rotate(heading, heading.perp());
        matTransform.translate(pos.x, pos.y);
        matTransform.transformVector2Ds(pointList);
