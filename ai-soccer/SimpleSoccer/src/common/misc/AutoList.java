...
// Unfortunatelly this class is not "Auto" You have to call add()/remove() method in your class
public class AutoList<T extends Object> {

    // just for tagging class witch use AutoList
    public static interface Interface {}
    
    static private Map<Class<?>, Object> m_Members = new HashMap<>();
    ...
    private List<T> getList(Class<?> type) {
        ...
        if (!m_Members.containsKey(type)) {
            classType = type;
            m_Members.put(type, new LinkedList<>());
        }
