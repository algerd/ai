...
public class Region {
    ...
    public void render(boolean ShowID) {
        ...
        Cgdi.gdi.GreenPen();
        Cgdi.gdi.Rect(left, top, right, bottom);
        if (ShowID) {
            Cgdi.gdi.TextColor(Cgdi.green);
            Cgdi.gdi.TextAtPos(center(), StreamUtilityFunction.ttos(getId()));
        }
    }
    ...
    public Vector getRandomPosition() {
        return new Vector(Utils.randInRange(left, right), Utils.randInRange(top, bottom));
    }
