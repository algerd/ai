    ...
    public void enter(FieldPlayer player) {
        ...
        if ((player.isInHotRegion()
            ...
            if (Define.def(Define.PLAYER_STATE_INFO_ON)) {
                DbgConsole.debugConsole.print("Player ").print(player.getId()).print(" enters receive state (Using Arrive)").print("");
            }
        } else {
            player.getSteering().pursuitOn();
            if (Define.def(Define.PLAYER_STATE_INFO_ON)) {
                DbgConsole.debugConsole.print("Player ").print(player.getId()).print(" enters receive state (Using Pursuit)").print("");
            }
        }
    }
