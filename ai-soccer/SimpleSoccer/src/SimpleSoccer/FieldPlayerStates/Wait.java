...
public class Wait extends State<FieldPlayer> {
    ...
    public void enter(FieldPlayer player) {
        if (Define.def(Define.PLAYER_STATE_INFO_ON)) {
            DbgConsole.debugConsole.print("Player ").print(player.getId()).print(" enters wait state").print("");
        }
        //if the game is not on make sure the target is the center of the player's
        //home region. This is ensure all the players are in the correct positions ready for kick off
