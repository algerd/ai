...
abstract public class PlayerBase extends MovingEntity {
    ...
    public boolean isThreatened() {
        ...
        while (iterator.hasNext()) {
            ...
            if (isPositionInFrontOfPlayer(curOpp.getPosition()) && (getPosition().distSq(curOpp.getPosition()) < ParamLoader.instance.PlayerComfortZoneSq)) {    
                return true;
            }
        }
        return false;
    ...
    public void trackTarget() {
        setHeading(getSteering().getTarget().subn(getPosition()).normalizen());
    }
