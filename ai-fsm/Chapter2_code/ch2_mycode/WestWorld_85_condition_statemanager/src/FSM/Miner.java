...
public class Miner extends BaseGameEntity {   
    ...
    private MinerStateManager stateManager;
    ...
    public Miner(EntityEnum entity) {
        ...
        this.stateManager = new MinerStateManager(this);
        this.currentState = stateManager.getState(MinerStateEnum.GO_HOME);
    }
    ...
    public MinerStateManager getStateManager() {
