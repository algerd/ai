...
public class Telegram implements Comparable {
     ...
     */
    private double dispatchTime = -1;
    private EntityEnum sender;
    private EntityEnum receiver;
    ...
    public EntityEnum getSender() {
        return sender;
    }

    public void setSender(EntityEnum sender) {
        this.sender = sender;
    }

    public EntityEnum getReceiver() {
        return receiver;
    }

    public void setReceiver(EntityEnum receiver) {
        this.receiver = receiver;
    }
